...
const Circle = class Circle { 
    ...
    calcArea(){ //we are returning the area
...
const Student = class Student {
    ...
    grade = undefined;// Check the given declarations
    graduated = false;
 }
...
const Product = class Product {
    constructor(strInput){//Try to parse the input correctly
    ...
    let inStockArr = products.filter(element =>element.availability === "In Stock");// To find products in stock
    return inStockArr;
    }
